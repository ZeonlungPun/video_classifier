...
if __name__ == '__main__':
    ...
    parser.add_argument("--new_width", type=int, default=300, help='resize image width')
    parser.add_argument("--new_height", type=int, default=800, help='resize image height')
