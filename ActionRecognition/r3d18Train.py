...
dataset = CustomVideoDataset(root_dir='./testvideo2', transform=transform, frames_per_clip=8)
...
new_video_path = './testvideo2/horse_riding/v_riding_01_01.avi'  # 替換為新視頻的路徑
