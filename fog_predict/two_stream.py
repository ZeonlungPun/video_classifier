...
class ThreeStream(nn.Module):
    def __init__(self,num_classes,optical_channels):
        ...
        self.SpatialModel = CustomBranch(num_classes=num_classes,in_channel=3,branch_name='resnet50')
        self.OpticalModel= CustomBranch(num_classes=num_classes,in_channel=optical_channels,branch_name='resnet50')
        self.siftModel= CustomBranch(num_classes=num_classes,in_channel=3,branch_name='resnet50')
